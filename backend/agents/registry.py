...
def initialize():
    ...
    _REGISTRY = {
        ...
        "classifier": {
            "id": "classifier",
            "name": "Classificador de Intent",
            "module": "Sistema",
            "description": "Classifica o pedido do usuário em task_type e gera hints para o Supervisor.",
            "system_prompt": CLASSIFIER_SYSTEM_PROMPT,
            "model": "openai/gpt-4o-mini",
            "model_source": "local",
            "tools": [],
            "runtime_keys": ["classifier"],
            "supports_prompt_edit": True,
            "supports_tools_edit": False,
        },
        "web_researcher": {
            ...
            "module": "Arcco Chat",
            "description": "Executa buscas web precisas e retorna dados verificados com fontes.",
            "system_prompt": WEB_RESEARCHER_PROMPT,
            "model": "openai/gpt-4o-mini",
            "model_source": "local",
            "tools": [],
            "runtime_keys": ["web_researcher"],
            "supports_prompt_edit": True,
            "supports_tools_edit": False,
        },
        "code_creator": {
            "id": "code_creator",
            "name": "Criador de Código",
            "module": "Arcco Chat",
            "description": "Gera e executa código Python no sandbox E2B com auto-correção.",
            "system_prompt": CODE_CREATOR_PROMPT,
            "model": "openai/gpt-4o-mini",
            "model_source": "local",
            "tools": [],
            "runtime_keys": ["code_creator"],
            "supports_prompt_edit": True,
            "supports_tools_edit": False,
        },
    }

    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "- É permitido criar arquivos intermediários, extrair texto/imagens, estruturar JSON, gerar HTML e produzir o artefato final\n"
                "- O objetivo é resolver o problema do usuário, não apenas executar um cálculo isolado\n\n"
                "ANTI-EXEMPLOS — O QUE NÃO FAZER:\n\n"
